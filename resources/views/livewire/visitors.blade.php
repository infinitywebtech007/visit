                ...
                <div class="visitor-search-container" style="position: relative;">
                    ...
                    <div class="input-group">
                        <input 
                            ...
                            placeholder="Type mobile number to search visitors..."
                            autocomplete="off"
                            minlength="2"
                        >
                        @if($visitor_id)
                                    ...
                                    <div class="visitor-option" 
                                        ...
                                        <div style="font-size: 0.85em; color: #666; margin-top: 2px;">
                                            ...
                                            @if($visitor->company_name)
                                                <span class="badge badge-light ml-1">{{ $visitor->company_name }}</span>
                                            @endif
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    @if($visitor_id && $selectedVisitorName)
                        @php
                            $selectedVisitor = \App\Models\Visitor::select('mobile', 'company_name')->find($visitor_id);
                        @endphp
                        <div class="selected-visitor-info mt-2 p-2" style="background-color: #f8f9fa; border-radius: 4px; font-size: 0.9em;">
