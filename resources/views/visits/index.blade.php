        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                @haspermission('visits-create')
                    <a href="{{ route('visits.create') }}" class="btn bg-teal m-2 float-right"><div class="fa fa-plus"></div></a>
                @endhaspermission
            </div>
        </div>
        @if (session('success'))
                                        ...
                                        <td>
                                            @if (is_null($visit?->out_time))
                                                <x-adminlte-button data-id="{{ $visit->id }}"
                                                    data-name="{{ $visit->visitor->name }}" class="btn btn-sm bg-teal rounded" data-toggle="modal"
